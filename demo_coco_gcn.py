...
def main_coco():
    ...
    if args.inductive:
        ...
        model = trans_resnet101(num_classes=num_classes, t=args.t, p=args.p, pretrained=True, adj_file='data/coco/coco_adj.pkl')
    else: model = gcn_resnet101(num_classes=num_classes, t=args.t, p=args.p, pretrained=True, adj_file='data/coco/coco_adj.pkl')
